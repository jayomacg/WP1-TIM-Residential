...
Finnaly, it is worth mentioning SEAI’s National Energy Modelling Framework (NEMF), which is a suite of modelling tools used for modelling the Irish energy system. Some of the main models used in the NEMF include:
\begin{itemize}
...
The listed NEMF models and more are used by SEAI to model the impact of incentives and opportunities created by specific policy instruments. The models are a combination of top down, .......... 
