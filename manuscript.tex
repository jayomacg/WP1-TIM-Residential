...
\begin{abstract}
%% Text of abstract
Under the climate action bill, the Irish government have set legally binding targets to reduce greenhouse gas (GHG) emissions by 51\% in 2030, compared to 2018 and to achieve “net-zero” GHG emissions by 2050. These legally binding targets are set, so Ireland must comply with the objective of the Paris Agreement. 
Ireland and impartiular Ireland's residential sector is preforming poorly when compared to other EU countries. Ireland has the lowest renewable heat of 6.3\% \cite{2021EurostatExplorer}
