...
The results from TIM can provide some valuable insights on the residential sector and the sectoral interconnections when targeting carbon budgets, and long-term climate targets. While the purpose of this paper was to describe the residential methodology, the results used here only scrape the surface in terms of exploring residential decarbonisation. However, the results provide some initial insights into residential decarbonisation and are discussed in section \ref{Discussion}. Three different scenarios are used to explore the results, those scenarios and descriptions are:

\begin{enumerate}[(a)]
    \item \textbf{No Mitigation} Least cost solution, where no emissions constraints are imposed
    \item \textbf{Previous Effort } complies with Climate Action Plan 2019, reduces Non-ETS GHG by 30\% in 2030 compared to 2005, and net-zero in 2050.
...
While the first two scenarios do not comply with the Climate Action and Low Carbon Development (Amendment) Act 2021 target of an overall 51\% GHG reduction in 2030 compared to 2018, they do provide insights on the incremental steps required to achieve these targets. 
...
While the Climate Action Plan 2019 targeted 500,000 retrofits, the model only retrofitted 90,000 up to 2030, however, all these retrofits are deep and on larger detached dwellings. The number of retrofits jumps up to 615,000 in the Current Effort scenario, there is a mix of types of depth of retrofits with different dwelling types, but no apartments are retrofitted. The cumulative energy savings are displayed on the secondary axis.
