...
Also non- archetype energy servies demands - 
...
The final version of the newly developed TIM provides some valuable insights on each sector and the sectoral interconnections. The results outlined in this paper are based upon six scenarios. TIM can only analysis the energy system, the other large source of GHG emissions is from agriculture, therefore some scenarios are labelled based on agriculture GHG reduction (AXX) and Energy System GHG reduction (EXX), the six scenarios are:
\begin{itemize}
...
While the first two scenarios do not comply with the overall 51 \% GHG reduction in 2030 compared to 2018 or net-zero by 2050, however they do provide insights on the incremental steps required. The last four scenarios comply with the overall 51 \% target and net-zero by 2050 and offer insights about different trajectories to achieve those targets.  
