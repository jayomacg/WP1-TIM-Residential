...
PREVIOUS RESIDENTIAL ESOM FOR IRELAND 
\cite{Uidhir2020ResidentialIreland} \cite{Uidhir2020ImprovingDecisions}
\cite{Dineen2011ModellingHeating}
\cite{Dineen2015ImprovedSource}
\cite{Rogan2014LEAPsSystem}
\cite{Chiodi2013ModellingSystem} - more general
\cite{Connolly2021AalborgEnergy-System}- EnergyPLAN more general
\cite{Thellufsen2019ImplementingIreland}-EnergyPLAN DH
\cite{Goodbody2013RegionalCommunities} - HOMER (Hybrid Optimization of Multiple Energy Resources)
...
\section{Methodology}
\label{LitR}
understand, collect and filter robust data along with feasible deployment rates into TIMES framework to provide results, which are analysed internally and externally to give insights on optimally achieving 2030 and 2050 targets and five-year carbon budgets. 
FIGURE?
