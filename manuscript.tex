...
\usepackage[numeric-comp]{biblatex}
...
\title{Sustainable Irish homes in changing TIMES}
...
The Archetype Dwelling Energy Model SQL (ArDEM-SQL) is a simulation model built on IS EN 13790, which converts the BER public database into Microsoft SQL language and then calculates annual energy consumption for space heating, water heating, pumps \& fans and lighting. ArDEM-SQL, is only used to change internal temperatures and that data is then used in TIM. NOTE large variation in energy rating due to occupancy behaviour - 
